...
# Using SDS Loss maybe, also the stylization procedure have some problem. therefore we use the same structure as ip2p,
# which means we use a guidance file in threestudio/models/guidance/stable_diffusion_controlnet_guidance.py for more efficient. (hope so....)
import os
import tyro
import glob
import imageio
...
def process(opt: Options, path):
    ...
    # Here will use a guidance for efficient stylization
